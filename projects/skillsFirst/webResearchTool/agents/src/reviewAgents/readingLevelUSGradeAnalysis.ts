...
export class ReadingLevelUSGradeAnalysisAgent extends PolicySynthAgent {
  ...
  async processJobDescription(jobDescription: JobDescription) {
    ...
    jobDescription.readingLevelUSGradeAnalysis = jobDescription.readingLevelUSGradeAnalysis || {} as readingLevelUSGradeAnalysis;
...
Do not include any explanations or additional text. Output only the JSON object.`;
    ...
    if (result) {
      ...
      readingLevelUSGradeAnalysis.usGradeLevelReadability = result["U.S. Grade Level Readability"];
      readingLevelUSGradeAnalysis.readabilityLevelExplanation = result["Readability Level Explanation"];
